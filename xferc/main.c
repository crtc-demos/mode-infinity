...
static int spare_len = 0 ;

bbc_status_t bbc_readline(serial_h com, char *buffer, int size)
{
...
bbc_status_t bbc_read(serial_h com, char *buffer, int *size)
{
  if ( spare_len > 0 ) {
    if ( spare_len < *size )
      *size = spare_len ;
...
static int baudrates[N_BAUD_RATES] = { 1200, 2400, 4800, 9600, 19200 } ;
